...
public class P03 {
	...
	public static void main(String[] args) {
		...
		System.out.println("주  소 : 경기 성남시 분당후 황새울로351번길 10, 1층");
		System.out.println("대표자 : 유창선");
		System.out.println("사업자 : 752-53-00558" + "          TEL : 7055695");
		System.out.println("---------------------------------------------------");
		System.out.printf("금  액 %40s 원\n", df.format((int)k31_netPrice));
		System.out.printf("부가세 %40s 원\n", df.format((int)k31_tax));
		System.out.printf("합  계 %40s 원\n", df.format(k31_Price));

		
		System.out.println("---------------------------------------------------");
		System.out.println("우리카드");
		System.out.println("카드번호 : 5387-20**-****-4613(S)");
		...
		System.out.println("                                표준 V2.08_20200212");
