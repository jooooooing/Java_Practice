...
public class P04 {
	...
	public static void main(String[] args) {
		...
		System.out.println("=============================================");
		System.out.printf("%s\t %d\t %d\t %d\t %d\t %d\t\n", name, korean, english, math, main.sum(korean, english, math), 
				main.avg(korean, english, math));
		System.out.println();
		...
		System.out.printf("%s\t %d\t %d\t %d\t %d\t %d\t %d\t\n", name, korean, english, math, science, 
				main.sum(korean, english, math, science), main.avg(korean, english, math, science));
		System.out.println();
		...
		System.out.println("============================================================");
		System.out.printf("%s\t %d\t %d\t %d\t %d\t %d\t %d\t %d\t\n", name, korean, english, math, science, society, 
				main.sum(korean, english, math, science, society), main.avg(korean, english, math, science, society));
